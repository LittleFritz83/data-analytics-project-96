...
from leads 
  inner join sessions 
     on leads.visitor_id = sessions.visitor_id and 
        (leads.closing_reason = 'Успешно реализовано' or 
         leads.status_id = 142) 
...
from tab1
  left join purchases_tab3 
    on tab1.visit_date = purchases_tab3.visit_date and 
       tab1.source     = purchases_tab3.source     and 
       tab1.medium     = purchases_tab3.medium     and 
       tab1.campaign   = purchases_tab3.campaign
  left join leads_tab3     
    on tab1.visit_date = leads_tab3.visit_date     and 
       tab1.source     = leads_tab3.source         and 
       tab1.medium     = leads_tab3.medium         and 
       tab1.campaign   = leads_tab3.campaign
  left join cost_tab2      
    on tab1.visit_date = cost_tab2.campaign_date   and 
       tab1.source     = cost_tab2.utm_source      and 
       tab1.medium     = cost_tab2.utm_medium      and 
       tab1.campaign   = cost_tab2.utm_campaign
  left join visitors_tab4  
    on tab1.visit_date = visitors_tab4.visit_date  and 
       tab1.source     = visitors_tab4.source      and 
       tab1.medium     = visitors_tab4.medium      and 
       tab1.campaign   = visitors_tab4.campaign
)
select *
from tab2
order by revenue desc, visit_date, visitors_count desc, 
